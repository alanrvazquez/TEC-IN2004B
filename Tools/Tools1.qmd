...
## Saving the objects into Excel

</br></br></br>

We can save the **pandas** data frames into Excel using the function `.to_excel()`.

```{python}
#| eval: true
#| echo: true

# summary_penguins_data.to_excel("summary_penguins_data.xlsx")
```
