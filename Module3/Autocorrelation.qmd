...
- To this end, we use the `root_mean_squared_error()` function with the validation responses and our predictions.
...
rmse = root_mean_squared_error(Canadian_validation["Hours per Week"], 
                         forecast_Canadian)  
print(round(rmse, 2))
```
...
naive_rmse = root_mean_squared_error(Canadian_validation["Hours per Week"], 
                                naive_forecast)
print(round(naive_rmse, 2))
```
...
rmse = root_mean_squared_error(Airline_validation["Number of passengers"], 
                        forecast_Airline)  
print(round(rmse, 2))
```
...
naive_rmse = root_mean_squared_error(Airline_validation["Number of passengers"], naive_forecast)
print(round(naive_rmse, 2))
```
