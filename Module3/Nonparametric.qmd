...
The "Hitters.xlsx" dataset contains data collected from Major League Baseball players. It includes information on various statistics such as number of hits, years in the league, and salary.
...
plt.axvline(x=5.5, ymin=0.538, color='black', linewidth=3)  # Left vertical
