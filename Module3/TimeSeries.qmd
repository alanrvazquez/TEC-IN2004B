...
rmse = root_mean_squared_error(Y_valid, Y_val_pred_lin)  
print(round(rmse, 2))
```
...
rmse_quad = root_mean_squared_error(Y_valid, Y_val_pred_quad) 
print(round(rmse_quad, 2))
```
...
X_quad_season = pd.concat([Amtrak_train['t'], Amtrak_train['t']**2, 
                          dummy_data], axis = 1)
```
...
rmse_season = root_mean_squared_error(Y_valid, Y_pred_valid) 
print(round(rmse_season, 2))
```
