...
In practice, we use the square root of the mean prediction error:
...
::: notes
Prediction of tesla car next month, 1000 USD.
Prediction of ON running shoes next month, 20 USD.
:::
