...
::: notes
Profitable clients are those who pay interest on outstanding balances, pay a lot with credit card (because paying with credit card incurs in fees paid by the merchant. annual memberships, opening other accounts.)
:::
...
- [**Predictors**]{style="color:darkblue;"}. They are represented using the notation $X_1$ for the first predictor, $X_2$ for the second predictor, ..., and $X_p$ for the *p*-th predictor.
