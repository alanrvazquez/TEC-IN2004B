...
La [**regresión**]{style="color:green;"} intenta estimar o predecir, para cada individuo, el valor numérico de alguna variable para ese individuo. Por ejemplo, "¿Cuánto utilizará el servicio un cliente determinado?"
