...
The tree created above has two weaknesses. First, it is very large, making it difficult to visualize. Second, it can suffer from overfitting. That is, it performs very well on the training data, but poorly on unobserved validation data.
