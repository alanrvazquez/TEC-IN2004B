...
::: incremental
-   [**Training data**]{style="color:blue;"} is data that we use to train or construct an approximation $\hat{C}(\boldsymbol{X})$ to the true Bayes Classifier $C(\boldsymbol{X})$.
