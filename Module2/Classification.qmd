...
That is, classification algorithms use predictor values [*to predict the class*]{style="color:#4682B4;"} of the response (either target or reference).
...
So, for an unseen record, they use predictor values to predict whether the record belongs to the target class or not.
