...
plt.axhline(y=9.8, color='black', linewidth=3)     # Horizontal line
plt.axvline(x=10.9, ymin=0, ymax=0.47, color='black', linewidth=3)  # Left vertical
plt.axvline(x=11.2, ymin=0, ymax=0.47, color='black', linewidth=3)  # Right vertical
