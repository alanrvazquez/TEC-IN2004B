...
::::: columns
::: {.column width="60%"}
- La tabla de recetas contiene los datos generales de cada receta expedida: número de receta (es la llave), fecha, hora de consulta, un indicador de si contiene medicamentos controlados o no, y el identificador del paciente, este campo permite _**relacionar los datos de la receta**_ con los datos del paciente.
:::
