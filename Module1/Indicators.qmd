...
![](images/KPI_tiktok.png){fig-align="center"}
...
- Variables used as stratification criteria are called "[Analysis Dimensions]{style="color:lightblue;"}" (they are dimensions from the perspective of data).
...
A [leading indicator]{style="color:darkgreen;"} measures the performance of factors that are critical now to achieving a desired outcome in the future.
...
::: {style="font-size: 80%;"}
1. Equipment reliability in a manufacturing plant

2. On-time delivery performance of a logistics company

3. Product quality in a manufacturing process

4. Inventory management performance of a retail company

5. Workplace safety performance in a manufacturing plant. 
:::
