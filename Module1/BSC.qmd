...
1.  Management by Objectives (MBO; Peter Drucker, 1954).
2.  Hoshin Kanri.
3.  [**Balanced Score Card (BSC; Kaplan & Norton, 1992, 1996)**]{style="color:#000080;"}
...
![](images/BSC_banco.png){fig-align="center"}
...
:::
::: {.column width="60%"}
![](images/data-studio-logo.png){fig-align="center" width="422"}
:::
:::
...
Let's load the data into Data Studio
...
## Tutorials on Data Studio (before Looker Studio)
